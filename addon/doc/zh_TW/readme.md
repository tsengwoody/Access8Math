...
* 可使用 LaTeX/AsciiMath 書寫數學內容
* 用來輸入 LaTeX/AsciiMath 語法的指令選單
* 用來输入 LaTeX/AsciiMath 的快捷手势
* 在编辑時協助更有效地移动游標
* 在编辑時即時閱讀含 LaTeX/AsciiMath 的內容
...
您可以在書寫設定中選擇要使用括號或錢號作為 LaTeX 分隔符。
...
* 可以正確區分向量和射線
* Access8Math HTML 文件中使用對話框顯示圖片、影片或聲音的資源
* Access8Math HTML 文件中使用新視窗開啟連結的資源
* 在互動導航模式下從 Math 物件複製 MathML 時導出 MathML 命名空間
* 相容於 NVDA 2023.1
