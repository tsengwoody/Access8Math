...
以 LaTeX 书写数学内容：按下菜单中的 「LaTeX...」 会显示一个可输入 LaTeX 内容的对话框，书写完成按下确认后，即可生成一个可与数学内容进行交互的 Access8Math 数学对象。

以 AsciiMath 书写数学内容：按下菜单中的 「AsciiMath...」 会显示一个可输入 AsciiMath 内容的对话框，书写完成按下确认后，即可生成一个可与数学内容进行交互的 Access8Math 数学对象。
...
*	在编辑区按下 alt+shift+向下键移动到当前数据区域并选取
