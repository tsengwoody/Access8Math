...
alt+h, alt+i, alt+l, alt+m 為書寫手勢群組，在編輯區中按 alt+w 可啟用或停用書寫手勢。
...
在編輯區按下 alt+s 啟用或停用快捷手勢。當快捷手勢啟用時按 f1~f12 可快速插入  LaTeX 語法。當快捷手勢啟用時按 shift+f1~f12 可讀出該快捷當下綁定的 LaTeX 指令。
...
*	「一般設定」對話框：
	...
	*	使用 NVDA+alt+字母來開關指令手勢：在編輯區的書寫手勢、區塊導航手勢、快捷手勢開關時是否需加上 NVDA 鍵
